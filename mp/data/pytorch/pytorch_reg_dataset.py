# ------------------------------------------------------------------------------
# From an mp.data.datasets.dataset_regression.RegressionDataset, create a 
# mp.data.pytorch.PytorchDataset. There are different types of datasets:
#
# PytorchReg2DDataset: the length of the dataset is the total number of slices 
# (forth dimension) in the data base. A resized slice is returned by __getitem__
#
# PytorchReg3DDataset: __getitem__ returnes the next instance, resized to the
...
class PytorchReg2DDataset(PytorchRegressionDataset):
...
class Pytorch3DQueue(PytorchRegressionDataset):
