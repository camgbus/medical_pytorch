...
class PytorchSegmentationDataset(PytorchDataset):
...
class PytorchSeg2DDataset(PytorchSegmentationDataset):
...
class PytorchSeg3DDataset(PytorchSegmentationDataset):
    ...
    def __init__(self, dataset, ix_lst=None, size=(1, 56, 56, 10),
        ...
        self.predictor = pred.Predictor3D(self.instances, size=self.size, norm=self.norm, resize=resize)
        self.resize = resize
...
class Pytorch3DQueue(PytorchSegmentationDataset):
