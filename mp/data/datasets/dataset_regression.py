# ------------------------------------------------------------------------------
# All datasets descend from this RegressionDataset class storing regression
# instances.
# ------------------------------------------------------------------------------
...
class RegressionInstance(Instance):
    def __init__(self, x_path, y_label, name=None, class_ix=0, group_id=None):
        r"""A regression instance, using the TorchIO library.
...
class RegressionDataset(Dataset):
    r"""A Dataset for regression tasks, that specific datasets descend from.

        Args:
        instances (list[RegressionInstance]): a list of instances
