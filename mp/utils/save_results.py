...
def save_results(model, noise, model_type, paths, pathr, losses_train, losses_val, accuracy_train,
    ...
    torch.save(model, os.path.join(storage_data_path, 'models', noise+'_'+model_type, 'model.zip'))
