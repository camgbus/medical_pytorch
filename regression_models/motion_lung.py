...
data.add_dataset(DecathlonLung(augmented=True, img_size=input_shape,
                 ...
                 noise='motion', nr_images=150, nr_slices=20,
...
paths = os.path.join(storage_data_path, 'models', 'motion', 'states')
pathr = os.path.join(storage_data_path, 'models', 'motion', 'results')
...
torch.save(model, os.path.join(storage_data_path, 'models', 'motion', 'model.zip'))
