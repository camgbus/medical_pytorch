...
from mp.agents.segmentation_domain_pred_IRM_dp_agent import SegmentationDomainPredictionIRMAgent
...
configs = [
    {'experiment_name': 'decath_harp_hybrid_aug_irmv1', 'device': 'cuda:0',
