...
from mp.agents.segmentation_semisup_domain_pred_IRM_dp_agent import SegmentationSemisupDomainPredictionIRMAgent
...
configs = [
    {'experiment_name': 'harp(24,6)_dryad_hybrid_aug_vrex_dp', 'device': 'cuda:0',
