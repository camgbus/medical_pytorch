...
config = {'experiment_name':'fix_unet_test', 'device':'cuda:7',
    'nr_runs': 1, 'cross_validation': False, 'val_ratio': 0.1, 'test_ratio': 0.2,
...
for run_ix in range(config['nr_runs']):
    ...
    agent.train(results, optimizer, loss_f, train_dataloader=dl,
        init_epoch=0, nr_epochs=2, run_loss_print_interval=1,
